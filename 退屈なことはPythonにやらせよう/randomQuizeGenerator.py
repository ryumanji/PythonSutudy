#! python3
#randomQuizeGenerator.py - ランダム順に問題と答えを並べ問題集と回答集を作る

import random

#問題データ。キーが都道府県で、値が県庁所在地
...
for quiz_num in range(2):
    ...
    quiz_file = open('C:\\Users\\ckn32\\work\\退屈なことはPythonにやらせよう\\都道府県問題集\\capitalsquiz{}.txt'.format(quiz_num + 1), 'w')
    answer_key_file = open('C:\\Users\\ckn32\\work\\退屈なことはPythonにやらせよう\\都道府県問題集\\capitalsquiz_answers{}.txt'.format(quiz_num + 1), 'w')
